...
from faceknow.face_5 import WxTools
from faceknow.settings12 import app_id, app_secret
...
while True:
    ...
    for c in contours:
        ...
        if not is_send_msg:
            ...
            wx_tools.send_wx_customer_msg('oTE_f0UEIejQ5x4HEqGtU5RXKglQ', '有人闯入了你的家，请留意')
